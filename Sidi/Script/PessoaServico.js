...
function marcaFornecedor() {
  cadastroPessoasServicos.gbServico_oferecido.FORNECEDOR.Click(); // o primeiro click é para dar foco na tela.
...
function insereGrupoCliente() {
  var pageControlPessoasServicos = Aliases.SIDI.frmPrincipal.MDIClient.frmPessoasServicos.PagePessoasServicos;
  pageControlPessoasServicos.SetFocus();
  pageControlPessoasServicos.ClickTab(2);
  pageControlPessoasServicos.tsCliente.PanelPessoasServicos2.gbCliente.GRUPO_CLIENTE.Keys("gera[Tab]");
}
...
function marcaEAN13() {
  ...
  pageControlPessoasServicos.SetFocus();
  pageControlPessoasServicos.ClickTab(2);
  pageControlPessoasServicos.tsCliente.PanelPessoasServicos2.gbCliente.USAR_PRODUTO_NF_REF.TGroupButton.ClickButton();
}

function insereInscricaoEstadual(insc) {
  var pageControlPessoasServicos = Aliases.SIDI.frmPrincipal.MDIClient.frmPessoasServicos.PagePessoasServicos;
  pageControlPessoasServicos.SetFocus();
  pageControlPessoasServicos.ClickTab(1);
  pageControlPessoasServicos.CadastroPessoasServicos.INSC_ESTADUAL.Keys(insc);
}
