...
function cadastrarPedido(){
 ...
 var codigoProduto = Project.Variables.PRODUTO_ESTOQUE.Value("PRODUTO"); 
   ...
   if (Aliases.REPRES.TMessageForm.Exists){
    Aliases.REPRES.TMessageForm.Yes.Click(); 
   }
   ...
   frmPedido.Paginas.tsdadosDadosBasico.gbCliente.VENDEDOR.Keys(codigoVendedor);
